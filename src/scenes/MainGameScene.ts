...
export class MainGameScene implements Experience
{
	...
	private addTrackFloor()
	{
		...
		const trackFloorModel: Model = this.engine.resources.getItem("TrackFloor");
	...
	{
		// eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
		const brainManModel: Model = this.engine.resources.getItem("BrainMan");
